...
const TextAreaField = ({
  ...
  return (
    <span
      className={`${className}  bg-main-50 flex items-start border border-main-700 px-3 py-1 rounded-lg transition-all focus-within:ring-1 focus-within:ring-main-500`}
    >
